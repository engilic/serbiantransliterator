...
- **Morphological intelligence (WASM/Rust):** Uvedena/poboljšana detekcija prefiksalnih/morfemskih granica da bi se izbeglo pogrešno spajanje digrafa (Љ, Њ, Џ) u osetljivim kontekstima (npr. _in-jekcija_, _kon-junkcija_, _nad-živeti_).
