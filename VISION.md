...
2.  **Slojevita zaštita:**
    - _Sloj 1:_ Rigidne liste (ALWAYS_LATIN).
    - _Sloj 2:_ Heuristike (MixedCase, CamelCase, underscore_names).
    - _Sloj 3:_ Sintaksna svesnost (prepoznavanje koda, URL-ova, e-mailova).
    - _Sloj 4 (Budućnost):_ Lokalni AI.
