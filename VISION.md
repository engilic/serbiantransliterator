...
4. **Strukturalni i Morfološki Integritet:** Sistem vidi dokument kao kompleksnu OOXML strukturu, a ne kao sirovi tekst. Implementacijom **MAX1 Morfološke inteligencije**, engine sada prepoznaje granice morfema (prefiks/koren), čuvajući lingvističku čistotu reči kao što su *in-jekcija* ili *nad-živeti*.
